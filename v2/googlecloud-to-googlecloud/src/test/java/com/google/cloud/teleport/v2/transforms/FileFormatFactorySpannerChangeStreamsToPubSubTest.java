...
public class FileFormatFactorySpannerChangeStreamsToPubSubTest {
        ...
        @Test
        public void test_getMarketplaceIdFromNftListing() {
                Assert.assertEquals(
                                "x2y2",
                                FileFormatFactorySpannerChangeStreamsToPubSub.getMarketplaceIdFromNftListing(
                                                "3dba4ca873d3cb37b7b172bdb2fd070d_x2y2_88099911"));

                Assert.assertEquals(
                                "blur",
                                FileFormatFactorySpannerChangeStreamsToPubSub.getMarketplaceIdFromNftListing(
                                                "6907e3109c98ee57d4d041d881d7d7f7_blur_d5eb0b9a8381a8122b2817b57b4b13ad"));

                Assert.assertEquals(
                                "opensea",
                                FileFormatFactorySpannerChangeStreamsToPubSub.getMarketplaceIdFromNftListing(
                                                "eb95ef72bfbcddf43c3403193264e604_opensea_34c39c49251bab4117ddf2ef1c2c68a7"));
        ...
        public void test_getIdsFromModsArray() {
                ...
                Collection<String> ids = FileFormatFactorySpannerChangeStreamsToPubSub.getIdsFromModsArray(
        ...
        @Test
        public void test_getMarketplaceIdsFromModsArray() {
                JsonObject jsonObj = JsonParser.parseString(json).getAsJsonObject();
                Collection<String> ids = FileFormatFactorySpannerChangeStreamsToPubSub.getMarketplaceIdsFromModsArray(
                                jsonObj.get("mods").getAsJsonArray());
